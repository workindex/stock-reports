...
> 수집: 2026-06-03 04:30 UTC · 출처: [CNN Markets](https://edition.cnn.com/markets/fear-and-greed)
...
> 수집: 2026-06-03 04:30 UTC · `python monitor.py --scan` 실행 시 갱신

| 지수 | 현재값 | 전일比 | 등급 | 시장 국면 | 신규 진입 |
|------|--------|--------|------|---------|---------|
| VIX (미국 S&P500) | 15.77 | -0.28 | ⚪ 중립 | 강한 상승 | ✅ 신규 진입 허용 |
| VKOSPI (한국 KOSPI) | N/A | — | — | — | — |
